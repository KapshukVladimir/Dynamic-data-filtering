...
} from "../../shared/constnats/default-values";
...
export class RangeFilterComponent implements OnInit {
  ...
  public rangeStartControl: FormControl = new FormControl<number>(DEFAULT_MIN_RANGE_VALUE);
  public rangeEndControl: FormControl = new FormControl<number>(DEFAULT_MAX_RANGE_VALUE);
